...
INSERT INTO [dbo].[pomodoro]([ultima_utilizacao],[inicializacao])
VALUES (getdate(), getdate())

INSERT INTO [dbo].[matriz_tempo]([ultima_utilizacao],[inicializacao])
VALUES (getdate(), getdate())

INSERT INTO [dbo].[usuario]([matriz_tempo],[pomodoro],[nome],[email],[senha],[salt],[data_nascimento])
VALUES (1,1,'Allex','allexxrodriguess@gmail.com','pWKzzvsyID3bW6eJ4gD6s5Xy2aaw4WrOIk8IC+Xm2AU=','XL2z3UkUhe4oh7FLu+Y43+ykQK5z+TdWr2HJ9pz1YlE=',cast('23/09/1998' as date));
